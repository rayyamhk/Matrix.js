...
/**
 * Find the eigenvaluse of any square matrix using QR Algorithm.
 ...
 * @return { Array } - Array of eigenvalues
 */
...
module.exports = function eigenvalues() {
  ...
  for (let i = size - 1; i > 0; i--) {
    ...
    while (true) {
      ...
      // if the current eigenvalues pair is complex and the difference of the
